		...
		<div class='evotrouble_right' style='text-align:center'>
			...
			<div class='evotrouble_bottom' style='padding-top:60px; text-align:center'>
				<div class='evo_support_box evo_troubleshoot'>
					<h2><?php _e('Having issues with EventON? ','eventon');?><br/>
						<a style='margin-top:8px; display:inline-block' class='evo_admin_btn' href='http://docs.myeventon.com/documentations/check-eventon-working/' target='_blank'><?php _e('Troubleshoot Guide to Eventon','eventon');?></a></h2>
